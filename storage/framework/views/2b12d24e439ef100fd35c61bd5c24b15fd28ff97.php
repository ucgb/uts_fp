<span class="d-block p-2 bg-dark text-white">
    ...
    <thead class="thead-dark">
      ...
      <?php endif; ?>
          ...
          <tr>
              ...
              <td>
                  <a class="btn btn-warning" href="/ubah-mhs/<?php echo e($i->id); ?>">Edit</a>
                  <a class="btn btn-danger" href="/hapus-mhs/<?php echo e($i->id); ?>"> Hapus</a>
              </td>
          </tr>
          </tbody>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
    ...
    <?php /**PATH D:\MATA KULIAH\Semester 6\Framework\myproject\resources\views/list-mahasiswa.blade.php ENDPATH**/ ?>