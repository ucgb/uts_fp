<span class="d-block p-2 bg-dark text-white">
    <h3>Tambah Data laptop Keluar</h3>
</span>
...
<form action="/simpan-laptop" method="POST" >
    <div class="form-group">
        ...
        <input class="form-control" type="number" name="merk_laptop" id="merk_laptop">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="tahun_produksi">tahun produki : </label>
...
<?php /**PATH C:\xampp\htdocs\myproject\resources\views/tambah-laptop.blade.php ENDPATH**/ ?>